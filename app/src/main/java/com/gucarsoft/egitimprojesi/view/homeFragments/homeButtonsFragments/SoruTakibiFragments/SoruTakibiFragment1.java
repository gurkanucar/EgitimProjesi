package com.gucarsoft.egitimprojesi.view.homeFragments.homeButtonsFragments.SoruTakibiFragments;
...
public class SoruTakibiFragment1 extends Fragment {
    RecyclerView rcView;
    SoruModelRCViewAdapter rcAdapter;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.soru_takibi_1,container,false);
